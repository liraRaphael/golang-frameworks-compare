...
type MockHelloUseCase struct {
	ExecuteFunc func(ctx context.Context, req requests.HelloRequest) (responses.HelloOutput, error)
}

func (m *MockHelloUseCase) Execute(ctx context.Context, req requests.HelloRequest) (responses.HelloOutput, error) {
...
type MockValidator struct {
	ValidateFunc func(ctx context.Context, input any) error
}

func (m *MockValidator) Validate(ctx context.Context, input any) error {
